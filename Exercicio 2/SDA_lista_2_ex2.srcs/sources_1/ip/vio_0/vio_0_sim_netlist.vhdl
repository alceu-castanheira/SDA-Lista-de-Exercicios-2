...
-- Date        : Tue Oct 13 00:19:03 2020
-- Host        : LAPTOP-1MDN7U1C running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/alceu/Documents/Doutorado/SDA/SDA_lista_exercicios_2/SDA_lista_2_ex2/SDA_lista_2_ex2.srcs/sources_1/ip/vio_0/vio_0_sim_netlist.vhdl
-- Design      : vio_0
...
architecture STRUCTURE of vio_0_vio_v3_0_19_decoder is
  ...
  attribute SOFT_HLUTNM of \G_PROBE_OUT[0].wr_probe_out[0]_i_3\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \wr_en[4]_i_3\ : label is "soft_lutpair19";
...
\wr_en[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000800000000000"
        ...
        port map (
      I0 => \wr_en[4]_i_2_n_0\,
      I1 => \^g_probe_out[0].wr_probe_out[0]_i_6_0\,
      I2 => \^g_probe_out[0].wr_probe_out[0]_i_5_0\,
      I3 => \^g_probe_out[0].wr_probe_out[0]_i_4_0\,
      I4 => s_daddr_o(16),
      I5 => \wr_en[4]_i_3_n_0\,
      O => \wr_en[4]_i_1_n_0\
...
entity vio_0_vio_v3_0_19_probe_out_all is
  port (
    ...
    \G_PROBE_OUT[0].wr_probe_out_reg[0]_3\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  attribute ORIG_REF_NAME : string;
...
\G_PROBE_OUT[0].wr_probe_out[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \G_PROBE_OUT[0].wr_probe_out_reg[0]_3\,
      I5 => s_daddr_o(3),
...
entity vio_0_vio_v3_0_19_vio is
  ...
  attribute LC_TOTAL_PROBE_OUT_WIDTH of vio_0_vio_v3_0_19_vio : entity is 4;
  attribute ORIG_REF_NAME : string;
...
DECODER_INST: entity work.vio_0_vio_v3_0_19_decoder
     port map (
      ...
      s_den_o => bus_den,
      s_den_o_INST_0 => DECODER_INST_n_5,
...
PROBE_OUT_ALL_INST: entity work.vio_0_vio_v3_0_19_probe_out_all
     port map (
      ...
      \G_PROBE_OUT[0].wr_probe_out_reg[0]_3\ => DECODER_INST_n_8,
      Probe_out_reg(0) => Probe_out_reg(0),
      Q(0) => \^bus_di\,
      SR(0) => clear,
      clk => clk,
